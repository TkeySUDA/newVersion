...
#pragma mark - 确认绑定
        ...
        conYesButton.backgroundColor = [UIColor clearColor];
    ...
    if ([tag isEqualToString:@"1"]) {
        ...
        cancelBind.backgroundColor = [UIColor clearColor];
...
-(void)onCancelButton:(UIButton *)button
{
    ...
    identifyNumLabel.backgroundColor = [UIColor clearColor];
    ...
    confirmCancelBind.backgroundColor = [UIColor clearColor];
